...
namespace Autohand {
    [CustomEditor(typeof(OVRAutoHandAxisFingerBender))]
    public class OVRAutoHandAxisFingerBenderEditor : Editor{
        OVRAutoHandAxisFingerBender bender;

        void OnEnable() {
            bender = target as OVRAutoHandAxisFingerBender;
        }
