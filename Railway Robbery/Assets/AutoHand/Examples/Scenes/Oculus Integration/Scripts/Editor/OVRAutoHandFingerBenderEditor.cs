...
namespace Autohand {
    [CustomEditor(typeof(OVRAutoHandFingerBender))]
    public class OVRAutoHandFingerBenderEditor : Editor{
        OVRAutoHandFingerBender bender;

        void OnEnable() {
            bender = target as OVRAutoHandFingerBender;
        }
